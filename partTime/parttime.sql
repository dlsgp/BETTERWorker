...
/*스케쥴 테이블 db삽입*/
insert into schedule VALUES(schedule_num_seq.NEXTVAL, 7, 1, 'adminb', 'eee' , 10 , 'eee', TO_DATE('2024-01-02', 'YYYY-MM-DD' ), TO_TIMESTAMP('2024-08-13 09:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2024-08-13 18:00:00', 'YYYY-MM-DD HH24:MI:SS'), '13:00-14:00','파랑색', '이상없음', '0');
insert into schedule VALUES(schedule_num_seq.NEXTVAL, 8, 1, 'adminb', 'fff' , 20 , 'fff', TO_DATE('2024-01-11', 'YYYY-MM-DD' ), TO_TIMESTAMP('2024-08-14 09:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2024-08-14 18:00:00', 'YYYY-MM-DD HH24:MI:SS'), '12:00-13:00','빨강색', '이상없음', '1');
            
/*수습 직원form 정보 업데이트 수정 update문*/
